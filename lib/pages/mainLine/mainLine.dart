...
class MainLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
       appBar: new AppBar(
        title: Text('Main Line',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color:Colors.black),),
        elevation: 0.0,
      ...
      body: ListView(
       ...
       onPressed: () {
         Navigator.push(
               context,
               MaterialPageRoute(builder: (context) => AddNewTicket("MainLineTicketDetails",MainLine() )),
             );
       },
...
//       try{
//         DocumentReference ref = await db.collection('MainLineTicketDetails').
